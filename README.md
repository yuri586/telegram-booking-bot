...
![CI](https://github.com/yuri586/telegram-booking-bot/actions/workflows/ci.yml/badge.svg)

## О проекте

**Telegram Booking Bot** — продуктовая реализация Telegram-бота для записи клиентов на услуги.

Проект собран на базе переиспользуемого [Telegram Bot Template](https://github.com/yuri586/telegram-bot-template) и показывает, как из общей платформенной основы можно собрать конкретный коммерческий сценарий: выбор услуги, выбор свободного времени, создание записи, уведомления, админка услуг и расписания.
...
Проект разработан в формате **AI-assisted development**.

Я отвечал за постановку задачи, проектирование пользовательских и админских сценариев, проверку архитектурных решений, запуск проекта, анализ ошибок и логов, отладку, тестирование и доведение бота до рабочего состояния.

Код создавался с активным использованием AI-инструментов. При этом я проверял результат вручную: запускал сценарии, смотрел логи, исправлял проблемы, проверял миграции, тесты и итоговое поведение бота.
